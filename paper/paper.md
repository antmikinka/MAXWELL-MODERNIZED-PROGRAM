...
- **1307 tests** passing (629 core + 612 JAX adapter + 66 SymPy verification), 50 mathematical validations, 81 cross-module verification checks
...
The project maintains 1307 tests across 24 test modules, all passing. The test suite covers:
...
- **`test.yml`**: Runs the full 1307-test suite on Ubuntu, Windows, and macOS with Python 3.10, 3.11, and 3.12 (6 job combinations). Verifies imports of key modules. Triggers on push to `main` and all `feat/**` branches, and on pull requests.
